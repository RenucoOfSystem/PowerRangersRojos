...
public class MenuActivity extends AppCompatActivity {
    ...
    private void fillMainMenuTask(int op) {
        items.add(new MainMenuTask("Reparador de computadoras", "Pablo Alvarado", R.drawable.ic_computer, "Experiencia en software Windows 10", 76790146, "geo:0,0?q=-16.508285, -68.126612", "Pizza mía"));
        items.add(new MainMenuTask("Profesor de Matemáticas", "Ena Arkea", R.drawable.ic_escuela, "Experiencia con temas de 4to a 6to de Primaria", 77141001, "geo:0,0?q=-16.506470, -68.118500", "Colegio Santa María"));
        ...
        items.add(new MainMenuTask("Delivery", "Pablo Alvarado", R.drawable.ic_motorcycle, "Mayor de 19 años, licencia de conducir y experiencia con motocicletas", 76790146, "geo:0,0?q=-16.508285, -68.126612", "Pizza mía"));
